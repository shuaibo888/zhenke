...
import { AGREEMENT_UPDATED_DATE, agreementContent, type AgreementType } from '@/config/agreements';
      ...
      >
        {agreementOpen && (
          <article className={styles.authAgreementDocument}>
            <p className={styles.authAgreementUpdated}>更新日期：{AGREEMENT_UPDATED_DATE}</p>
            ...
            <p>如您对本协议或政策有疑问，可联系平台客服：<a href={CUSTOMER_SUPPORT_MAILTO}>{CUSTOMER_SUPPORT_EMAIL}</a>。商品售后或投诉请查看<Link to="/support">售后与投诉说明</Link>。</p>
          </article>
        )}
      </Modal>
    </>
