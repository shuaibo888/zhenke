    ...
    <main className={`${pageStyles.page} ${styles.page}`}>
      ...
      <article className={styles.document}>
        ...
        <details className={styles.serviceRules}>
          ...
          <h2>退货退款</h2>
          <p>快递订单确认收货后，可在订单中选择“仅退款（无需退货）”或“退货退款”，两种方式均需商家审核。退货申请通过后，按订单售后记录中的收件地址寄回并填写物流单号；商家确认收到退货后发起退款。申请被拒绝时可查看理由并重新申请，历史记录保留。</p>
          <p>已发货但尚未收货的订单暂不支持在线申请退款，请先联系商家处理，勿为申请退款提前确认收货。未发货订单继续通过“申请退款”处理；线下核销订单不支持寄回商品。</p>
